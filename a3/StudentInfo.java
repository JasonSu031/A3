...
public class StudentInfo {
	...
	public static void display() {
		...
		System.out.println("************************************************************");
		System.out.println("*   Student Name: Xingjian (Jason) Su                      *");
		System.out.println("*   ID: 300074626                                          *");
		System.out.println("*   Section: C01                                           *");
		System.out.println("*   Student name: Zijun Ye                                 *");
		System.out.println("*   Id: 300168065                                          *");
		System.out.println("*   Section: C03                                           *");
		System.out.println("*                                                          *");
		System.out.println("************************************************************");
